	...
	<div class="container">
		...
		<div class="category">
			...
			<div class="list-group">
				...
				<a href="#"
				   class="list-group-item list-group-item-action active" style="background-color: green">Category</a>
				   <?php foreach ($categories as $category ) {?>
			...
			<div class="list-group mt-5">
				...
				<a href="#"
				   class="list-group-item list-group-item-action active" style="background-color: green">Author</a>
				   <?php foreach ($author as $authors ) {?>
